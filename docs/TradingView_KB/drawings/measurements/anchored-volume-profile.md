...
**Source:** https://www.tradingview.com/support/solutions/43000707989-anchored-volume-profile/
...
- Next, the indicator does the same with the "3" timeframe. The 3m chart for the symbol has 7D * (1440 / 3) = 3360 bars of data. This is below the 5000 bar limit, so the 3m bars will be used in the AVP calculation.
...
**PreviousPreviousFixed Range Volume Profile drawing tool**NextNextHow to add text to Сhannel tools?**Launch Supercharts
